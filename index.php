...
<body>
   ...
   <header class="header d-flex justify-content-between">
      ...
      <div class="d-flex align-items-center mb-3">
         <img id="logo" src="./google.png" alt="logo">
         <h5 class="mb-0 ms-2 privacy">Privacy e termini</h5>
   ...
   <main class="main">
      ...
      <div class="container">
         ...
         <?php foreach ($faqArray as $singleFaq) { ?>

            <?php foreach ($singleFaq as $type => $string) { ?>

               <?php if ($type == "request") { ?>

                  <h2 class="request"><?php echo $string ?></h2>

               <?php } else { ?>

                  <p class="reply"><?php echo $string ?></p>
